...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 93IC9rDC7CKL/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: OdLK9AjY-uF-/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: XzMVHYH7juDT/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___9DeK1)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__gfUf9)}
                role={"img"}
              />
            ),
